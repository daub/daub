...
var cases = [
        require('decanat-engine-case-escape'),
        require('decanat-engine-case-for'),
        require('decanat-engine-case-if'),
        require('decanat-engine-case-else'),
        require('decanat-engine-case-close'),
        require('decanat-engine-case-variable'),
        require('decanat-engine-case-partial')
    ];
